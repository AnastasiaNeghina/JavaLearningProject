package com.neghina.gitworkflow;
...
public class GitWorkflow {
    public static void main(String[] args) {
        ...
        String step4 = "Perform git pull command - to merge the origin branches.";
        String step5 = "Perform git checkout -b new_branch_name command - to create and instantly move to a new branch, that is identical to local master branc.";
        String step6 = "Add your changes that are related to the task.";
        String step7 = "Review your changes and check the code before committing them.";
        String step8 = "Execute git commit by using the Intellij interface, where you can seleect what changes you want to commit.";
