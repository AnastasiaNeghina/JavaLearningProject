package com.neghina.exceptionsservicetask;
...
//        System.out.println(TextManager.getTheTextLengthWithNoTryAndCatch(stringValue2));
        ...
        String filePath = "src/main/java/com/neghina/exceptionsservicetask/test.txt1";
        try {
